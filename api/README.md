...
```python
movie_id = 1
response = httpx.get(f"http://127.0.0.1:8000/movies/{movie_id}")
print(response.json())
```
...
```python
response = httpx.get("http://127.0.0.1:8000/ratings", params={"movie_id": 1})
print(response.json())
```
...
```python
response = httpx.get("http://127.0.0.1:8000/tags/5/1/superbe")
print(response.json())
```
...
```python
response = httpx.get("http://127.0.0.1:8000/analytics")
print(response.json())
```
